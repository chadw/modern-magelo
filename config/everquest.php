...
return [
    ...
    'alla_base_url' => 'https://alla.yourdomain.com/',            // https://alla.yourdomain.com

    // common item fields used when selecting item data in model relations
    'item_select_fields' => [
        'id', 'Name', 'icon', 'itemtype', 'bagslots', 'slots', 'augtype', 'stackable',
        'hp', 'mana', 'endur', 'ac', 'regen', 'manaregen', 'enduranceregen',
        'spellshield', 'shielding', 'damageshield', 'dotshielding', 'dsmitigation',
        'avoidance', 'accuracy', 'stunresist', 'strikethrough', 'healamt', 'spelldmg', 'combateffects',
    ...
    'aa' => [
        'display' => [
            'grant_only'    => true,        // show grant_only aa's if the player has at least 1 pt into it.
        ],
    ],
    ...
    'faction' => [
        'display' => [
            'values'        => true,       // show values. If false only displays friendly "name" such as Scowls, Indifferent
        ],
    ],

    // legacy links (only items work right now)
